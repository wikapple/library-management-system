...
-- Dumping data for table librarydb.libraryuser: ~9 rows (approximately)
...
INSERT INTO `libraryuser` (`UserId`, `Name`, `PhoneNumber`, `Email`, `PasswordHash`, `DateOfBirth`, `UserRoleId`) VALUES
	...
	(6, 'William Applegate', '5026485380', 'wikapple@iu.edu', '$2b$10$yA790ucqKk8lEu68xIyrBuXPOFBblJeQnoD1KtWTp8Ei7oFLk6V4a', '2024-02-25', 1),
...
-- Dumping data for table librarydb.mediacategories: ~20 rows (approximately)
...
BEGIN
	...
	INSERT INTO BaseRentalItem (NAME, description)
